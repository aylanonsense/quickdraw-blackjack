...
local CARD_APEX_TOP = GAME_TOP + 0.6 * CARD_HEIGHT
local CARD_APEX_BOTTOM = GAME_BOTTOM - 2.6 * CARD_HEIGHT
local CARD_APEX_LEFT = GAME_LEFT + 0.6 * CARD_HEIGHT
...
return {
  ...
  MUTE_ALL_SOUNDS = MUTE_ALL_SOUNDS
}
