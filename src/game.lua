...
local function initSounds()
  ...
  Sounds.gunclick = Sound:new("snd/gun_trigger_empty.mp3", 5)
  Sounds.gunclick:setVolume(0.5)
  Sounds.pew1 = Sound:new("snd/pew1.mp3", 8)
  Sounds.pew2 = Sound:new("snd/pew2.mp3", 8)
  Sounds.pew3 = Sound:new("snd/pew3.mp3", 8)
  Sounds.pew4 = Sound:new("snd/pew4.mp3", 8)
  Sounds.pew5 = Sound:new("snd/pew5.mp3", 8)
  Sounds.pew6 = Sound:new("snd/pew6.mp3", 8)
  Sounds.pew7 = Sound:new("snd/pew7.mp3", 8)
  Sounds.pew8 = Sound:new("snd/pew8.mp3", 8)
  Sounds.pew9 = Sound:new("snd/pew9.mp3", 8)
  Sounds.pew10 = Sound:new("snd/pew10.mp3", 8)
  Sounds.pew11 = Sound:new("snd/pew11.mp3", 8)
  Sounds.pew12 = Sound:new("snd/pew12.mp3", 8)
  ...
  Sounds.blackjack = Sound:new("snd/impact.mp3", 1)
  Sounds.titleLoop = Sound:new("snd/title_loop.ogg", 1)
  Sounds.titleLoop:setLooping(true)
  Sounds.roundStart = Sound:new("snd/honky-tonk-round-start.mp3")
  Sounds.roundStart:setVolume(0.75)
